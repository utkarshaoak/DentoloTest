Feature: Dentolo Registration
  ...
  Scenario Outline: Verify user should be able to navigate to the site and fill data on Tarifauswahl page
    ...
    And fill the details in policy details
      ...
      | Utkarsha(+) | Oak(+)      | 1.  | Januar | 2002 | utkarsha.oak@gmail.com | 176 379 69  | testt(+)       | 5         | 12      | Homburg       |
    ...
    Examples:
      ...
      | Zahnschutz Premium | 1.  | Januar | 2005 |
      | Zahnschutz Komfort | 2.  | April  | 2007 |
